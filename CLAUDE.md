...
| Voice             | ElevenLabs, one Voice Library voice (chosen by a casting, `ELEVENLABS_VOICE_ID`), **pre-generated** MP3 (model `eleven_multilingual_v2`, Czech) | no API calls at runtime, zero latency, works offline; no voice cloning — the repo is public        |
