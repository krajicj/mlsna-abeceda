...
/** The highest stage the kitchen can really play today; STEP-23 ("kolik je") raises it. */
export const MAX_NUMBER_LEVEL: Level = 2;
/** The highest stage the kitchen can really play today; STEP-26 (the word pattern) raises it. */
...
export function letterPool(settings: Settings, level: Level): Letter[] {
  ...
  switch (level) {
    ...
    case 3:
    case 4:
      // P4 adds the diacritics of the child's name on top of these – STEP-27.
