...
/** How many orders one sitting holds (návrh kap. 4). STEP-22 makes it settable in the parent corner. */
...
/**
 * The temporary parent code until the parent corner arrives (STEP-22, návrh kap. 9). It is not a
